...
def main():
    parser = get_common_argparser("End-to-End LLM Judge Pipeline Orchestrator (Interactive Query & Interactive Query Response)")
    ...
    # ───────────────────────────────────────────────
    # A-1: Interactive Query 생성 (generate_interactive_query.py)
    # ───────────────────────────────────────────────
    print("\n" + "="*60)
    print(">>> A-1. Interactive Query 생성 (generate_interactive_query.py)")
    print("="*60)
    cmd_interactive_query = [
        sys.executable, "generate_interactive_query.py",
        "--input_file", args.keypoints_file,
        "--output_file", args.interactive_queries_file,
        "--interactive_query_gen_model", args.interactive_query_gen_model,
        "--interactive_query_thinking_level", str(args.interactive_query_thinking_level),
    ] + common_project_args
    subprocess.run(cmd_interactive_query, check=True)
    print(f"-> Interactive Query 저장 완료: {args.interactive_queries_file}")

    # ───────────────────────────────────────────────
    # A-2: Interactive Query 질문 품질 Judge (judge_interactive_query.py)
    # ───────────────────────────────────────────────
    print("\n" + "="*60)
    print(">>> A-2. Interactive Query 질문 품질 평가 (judge_interactive_query.py)")
    print("="*60)
    cmd = [
    ...
    print(f"-> Interactive Query 평가 점수 저장 완료: {args.interactive_query_scores_file}")

    # ───────────────────────────────────────────────
    # [DEPRECATED] B-Track (Interactive Query Response Generation) — archived/
    # ───────────────────────────────────────────────
    # B-1: Interactive Query(KSS) Response 생성 (generate_interactive_query_response.py)
    # ───────────────────────────────────────────────
    # print("\n" + "="*60)
    # print(">>> B-1. Interactive Query Response 생성 (generate_interactive_query_response.py)")
    # print("="*60)
    # cmd = [
    #     sys.executable, "generate_interactive_query_response.py",
    #     "--input_file",      args.interactive_queries_file,
    #     "--output_file",     args.interactive_query_responses_file,
    #     "--keypoints_file",  args.keypoints_file,
    #     "--interactive_query_response_model",           args.interactive_query_response_model,
    #     "--interactive_query_response_thinking_level",  str(args.interactive_query_response_thinking_level),
    #     "--query_source",                args.query_source,
    # ] + common_project_args
    # subprocess.run(cmd, check=True)
    # print(f"-> Interactive Query Response 저장 완료: {args.interactive_query_responses_file}")

    # B-2: Interactive Query Response Judge (judge_interactive_query_response.py)
    # ──────────────────────────────────────────────
    # print("\n" + "="*60)
    # print(">>> B-2. Interactive Query Response Judge (judge_interactive_query_response.py)")
    # print("="*60)
    # cmd = [
    #     sys.executable, "judge_interactive_query_response.py",
    #     "--keyscene_summary_file", args.keyscene_summary_file,
    #     "--output_file", args.interactive_query_response_scores_file,
    #     "--interactive_query_response_judge_model", args.interactive_query_response_judge_model,
    #     "--interactive_query_response_judge_thinking_level", str(args.interactive_query_response_judge_thinking_level),
    #     "--query_source", args.query_source,
    # ] + common_project_args
    # subprocess.run(cmd, check=True)
    # print(f"-> Interactive Query Response 점수 저장 완료: {args.interactive_query_response_scores_file}")
