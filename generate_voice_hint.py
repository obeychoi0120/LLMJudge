...
- 2단계 (과거 정보 영구 차단): 이전 과거 맥락에서 이미 밝혀진 사실(시청자가 이미 아는 내용)이나 상식을 요약한 뒤, "이 정보들은 질문 소재에서 영구 제외한다"라고 선언하세요.
- 3단계 (미래 추측 차단): "결과나 스토리 전개를 묻는 미래 지향적 질문을 철저히 차단하겠다"라고 단호하게 선언하세요.
...
- 1단계 (과거 정보 영구 차단): [1. 과거 장면 요약]에서 이미 파악된 사실이나 일반 상식을 요약한 뒤, "이 정보들은 질문 소재에서 영구 제외한다"라고 선언하세요.
- 2단계 (미래 추측 차단): "결과나 스토리 전개를 묻는 미래 지향적 질문을 철저히 차단하겠다"라고 단호하게 선언하세요.
