...
3. 현재 시점 몰입 (톤앤매너 및 스포일러 금지): 답변을 알려면 반드시 '이후의 영상'을 봐야만 알 수 있도록 질문을 기획하세요. 특히 질문의 어조(Tone)는 상황에 따라 묘사된 씬의 분위기(긴장감, 슬픔, 경쾌함 등)를 절대 깨지 않도록 일치시켜야 합니다. (기본적으로는 옆사람에게 툭 던지는 자연스러운 구어체를 쓰되, 상황에 맞게 톤을 조절하세요.)
