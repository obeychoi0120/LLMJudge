...
3. 현재 시점 몰입 (톤앤매너 준수 및 뒷북/스포일러 금지): 답변을 알려면 반드시 '이후의 영상'을 봐야만 알 수 있도록 질문을 기획하세요. 특히 질문의 어조(Tone)는 상황에 따라 묘사된 씬의 분위기(긴장감, 슬픔, 경쾌함 등)를 절대 깨지 않도록 일치시켜야 합니다. ('뛰어난 AI 비서'가 시청자의 호기심을 부드럽게 자극하며 던지는 정중하고 흥미로운 존댓말로 작성하세요.)
