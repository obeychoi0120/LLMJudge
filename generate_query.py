...
def init_query_generator_model(model_name):
    ...
    [목표]
    영상을 주의 깊게 시청한 일반인이 실제로 궁금해할 만한 자연스러운 질문을 최대 10개까지 생성하세요.

    [질문 카테고리 가이드]
    생성하는 질문들은 아래 4가지 유형을 최소 한 개씩 포함해야 합니다.
    1. 포괄적/전체적 질문 (Global Context): 영상의 전체 흐름, 분위기, 스토리 요약을 묻는 내용 (1-2개)
       - 예) "여기 전체적으로 무슨 내용이야?", "이번 영상 결말이 대체 뭐야?"
    2. 핵심 사건/장면 (Core Events): 극의 전개상 중요한 특정 사건이나 인물의 행동 이유를 묻는 내용 (2-3개)
       - 예) "주인공이 아까 왜 갑자기 화낸 거야?", "영상 초반에 둘이 왜 싸운 거야?"
    3. 세부 디테일 (Fine-Grained Details): 영상에 짧게 스쳐 지나가는 글귀, 소품, 옷차림 등 지엽적인 디테일을 확인하는 내용 (2-3개)
       - 예) "아까 칠판에 적혀 있던 글씨 뭐라고 쓰여 있는 거임?", "주인공 책상 위에 엎어져 있던 책 제목이 뭐야?"
    4. 정보 탐색 (Information Search): 영상 내 등장하는 물건, 장소, 브랜드 등 호기심을 자극하는 실물 정보 (1-2개)
       - 예) "저기 찍힌 바다 엄청 예쁜데 어디 관광지야?", "영상 중간에 주인공이 입고 있는 저 자켓 디자인 특이한데 어디 거야?"

    [작성 규칙]
    - 어투: 실제 시청자가 인터넷 커뮤니티나 친구에게 대충 물어보는 듯한 매우 캐주얼하고 격식 없는 구어체(반말 위주)를 사용하세요.
